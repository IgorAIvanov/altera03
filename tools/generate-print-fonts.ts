...
// Поле `license` пакета лишається «MIT» — реєстр складених виразів не приймає, —
// тож єдине місце, де сказано про OFL, це нотиси нижче. Без них твердження
// пакета було б неповним, а вимога OFL — невиконаною.
//
