-- Швидкодія шару на стендовому обсязі. Кожен випадок тричі, до протоколу йде
-- МЕДІАНА: перший прогін після зміни функцій систематично повільніший (план ще
-- не в кеші), тож і «останній», і середнє міряли б заразом і це. Два контрольні
-- випадки — двічі, там середнє. Числа — docs/ledger-performance.md.
--
