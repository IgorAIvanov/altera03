...
-- Джерело: turnover_balance.schema.ts (TurnoverBalanceFiltersSchema) + manifest.json.
-- Сам запит звіту — рукописний, у db/turnover_balance.sql: app.turnover_balance_data(user_id, filters).
...
begin
  ...
  v_data := coalesce(app.turnover_balance_data(user_id, v_norm), '{}'::jsonb);
