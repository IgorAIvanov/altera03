...
begin
  ...
  when matched then update set
    ...
    updated_at = now()
  when not matched then insert (code, name, numeric_code, symbol, is_active)
    values (s.code, s.name, s.numeric_code, s.symbol, coalesce(s.is_active, true))
...
begin
  ...
  delete from app.currency where id = v_id;
