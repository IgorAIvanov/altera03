...
-- Прибирання legacy-груп епохи «доступу через інтерфейси» переїхало в struc.sql
-- під маркер to_regclass('app.user_group_permission'): migration.sql виконується
-- при КОЖНІЙ публікації, і без маркера чистка зносила б щойно створену
-- адміністратором групу, яку ще не встигли наповнити правами.
