...
Deno.test("шрифт: гривню надрукувати нічим — і проба це фіксує", () => {
  // ₴ (U+20B4) немає ні в кирилічному субсеті Roboto, ні у WinAnsi — і, як
  // з'ясувалося, у ЖОДНОМУ субсеті @fontsource/roboto. Тобто на папері вона
  // вийде порожньою рамкою, і полагодити це можна лише іншим джерелом
  // гарнітури.
  //
  // Проба тут не «перевіряє правильну поведінку», а тримає межу видимою: коли
  // шрифт зміниться, вона впаде — і це буде не поломка, а нагадування зняти
  // застереження з документації.
  assertEquals(fontFor("₴"), 0, "гліфа немає ніде — символ іде у вбудований шрифт рамкою");
});
