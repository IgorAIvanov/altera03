 ...
 *
 * Тому потрібне право — `view` на модель шаблону, а не `edit`: хендлер не
 * читає базу і нічого не пише, а JSON, який він малює, клієнт уже отримав
 * командами, перевіреними окремо. Строгіше право не захистило б нічого, зате
 * зламало б вкладку PDF користувачеві, який має шаблон лише переглядати.
 * Оголошення живе в `commands.access` маніфесту моделі.
 */
