...
`import_session` дає людині `list`/`get`/`close`/`volume`/`purge`.
...
Каналу приймання (спарювання, частини, підсумок) ще немає — наступний крок;
правил конвертації й рушія в ядрі немає свідомо (формат визріває в застосунку).
