...
| `icons.attachment` | Скріпка — прикріплений до запису файл. |
| `icons.download` | Стрілка в тацю — забрати файл на диск. |
| `icons.zoomIn` | Збільшити масштаб перегляду. |
| `icons.zoomOut` | Зменшити масштаб перегляду. |
| `icons.swap` | Поміняти половини місцями — переворот розділеного вікна. |
| `icons.undock` | Відчепити в окреме вікно — з розділеної половини в плавуче. |
| `icons.dock` | Повернути в розкладку — з плавучого вікна назад у половину. |
| `icons.fit` | Вписати вміст у вікно — вихідний масштаб перегляду. |
